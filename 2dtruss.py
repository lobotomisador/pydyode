...
def truss2d(nodes, bars, restraints, areas, elastic_moduli, loads, temperature_gradient=0, thermal_exp_coeff=12e-6, roller_x=[], roller_y=[]):
    continuity = zeros((len(bars), 2 * len(nodes)))
    lengths = []
    removed_dofs = []
